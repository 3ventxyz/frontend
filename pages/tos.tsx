export default function TOS() {
  return (
    <div className="px-[10%]">
      ...
      <ul>
        <li>
          <p>
            ...
            the Company downloaded by You on any electronic device, named 3vent
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to 3VENT PTE LTD, 7 TEMASEK BOULEVARD #12-07
      ...
      <ul>
        <li>By email: contact@3vent.xyz</li>
      </ul>
    </div>
  )
}
